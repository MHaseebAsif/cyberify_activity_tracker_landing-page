...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "From clock-in to AI insight. Cyberify is the workforce intelligence command center for modern teams that ship." },
      { name: "author", content: "Cyberify" },
